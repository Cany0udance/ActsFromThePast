...
- If you play with Acts From The Past and then play on the same modded profile with the mod disabled afterwards, trying to enter the Run History screen will crash the game! Either make a new modded profile just for testing this mod OR back up your modded profile.
- Acts From The Past is currently incompatible with several mods, including mods that add new Ancients (they probably won't show up). Please keep this in mind as you play.
