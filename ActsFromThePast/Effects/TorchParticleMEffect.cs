...
public partial class TorchParticleMEffect : NSts1Effect
{
    ...
    public static TorchParticleMEffect Create(float x, float y, bool renderGreen)
    {
        var effect = new TorchParticleMEffect();
    ...
    private void SetupAt(float x, float y)
    {
        ...
        _scale = (float)GD.RandRange(1.0, 2.0);  // Medium: 1.0-2.0 (vs Small: 0.5-1.0)
