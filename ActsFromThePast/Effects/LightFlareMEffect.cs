...
public partial class LightFlareMEffect : NSts1Effect
{
    ...
    public static LightFlareMEffect Create(float x, float y, bool renderGreen)
    {
        var effect = new LightFlareMEffect();
    ...
    private void SetupAt(float x, float y)
    {
        ...
        _scale = (float)GD.RandRange(4.0, 5.0);  // Medium: 4.0-5.0 (vs Small: 3.0-3.5)
